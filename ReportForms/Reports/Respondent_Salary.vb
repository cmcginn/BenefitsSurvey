...
Public Class Respondent_Salary
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRANCAPortal3.Respondent_Salary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRespondent_Salary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Respondent_Salary = New Respondent_Salary
        rpt.Site = Me.Site
        Return rpt
    End Function

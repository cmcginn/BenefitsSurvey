...
Public Class ShiftDifferentials
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRANCAPortal3.ShiftDifferentials.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedShiftDifferentials
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ShiftDifferentials = New ShiftDifferentials
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class Benefits_MedicalPlan_Exec
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Benefits_MedicalPlan_Exec.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRANCAPortal3.Benefits_MedicalPlan_Exec.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBenefits_MedicalPlan_Exec
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Benefits_MedicalPlan_Exec = New Benefits_MedicalPlan_Exec()
        rpt.Site = Me.Site
        Return rpt
    End Function

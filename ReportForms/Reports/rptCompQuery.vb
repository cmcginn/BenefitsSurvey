...
Public Class rptCompQuery
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRANCAPortal3.rptCompQuery.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCompQuery
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCompQuery = New rptCompQuery
        rpt.Site = Me.Site
        Return rpt
    End Function
